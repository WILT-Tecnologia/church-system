...
class UpdateMemberRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'civil_status_id' => ['sometimes','required', 'exists:aux_civil_status,id'],
            'nationality' => ['sometimes','required'],
            'naturalness' => ['sometimes','required'],
            'color_race_id' => ['sometimes','required', 'exists:aux_color_race,id'],
            'formation_id' => ['sometimes','required', 'exists:aux_formation,id'],
