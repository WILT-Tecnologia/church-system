...
class UpdateEventCallsRequest extends FormRequest
{
    /**
    ...
    public function rules(): array {
        return [
            ...
            'start_time' => ['sometimes', 'required', 'regex:/^([01]\d|2[0-3]):([0-5]\d)$/'],
            'end_time' => ['sometimes', 'required', 'regex:/^([01]\d|2[0-3]):([0-5]\d)$/', 'after:start_time'],
