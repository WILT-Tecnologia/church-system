  ...
  createMemberForm(): FormGroup {
    return this.fb.group({
      ...
      stepThree: this.fb.group({
        baptism_date: [
          this.data?.members?.baptism_date || null,
          [Validators.required],
        ],
        baptism_locale: [
          this.data?.members?.baptism_locale || null,
          [Validators.maxLength(255), Validators.required],
        ],
        baptism_official: [
          this.data?.members?.baptism_official || null,
          [Validators.maxLength(255), Validators.required],
        ],
        baptism_holy_spirit: [this.data?.members?.baptism_holy_spirit || false],
        baptism_holy_spirit_date: [
          this.data?.members?.baptism_holy_spirit_date || null,
        ],
        member_origin_id: [
          this.data?.members?.member_origin.id || null,
          [Validators.required],
        ],
        receipt_date: [
          this.data?.members?.receipt_date || null,
          [Validators.required],
        ],
      }),
    });
